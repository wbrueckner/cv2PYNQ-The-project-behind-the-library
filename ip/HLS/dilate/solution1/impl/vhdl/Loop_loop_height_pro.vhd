...
architecture behav of Loop_loop_height_pro is 
    ...
    component dilate_hls_mux_32g8j IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    dilate_hls_mux_32g8j_U24 : component dilate_hls_mux_32g8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    dilate_hls_mux_32g8j_U25 : component dilate_hls_mux_32g8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    dilate_hls_mux_32g8j_U26 : component dilate_hls_mux_32g8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    dilate_hls_mux_32g8j_U27 : component dilate_hls_mux_32g8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    dilate_hls_mux_32g8j_U28 : component dilate_hls_mux_32g8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    dilate_hls_mux_32g8j_U29 : component dilate_hls_mux_32g8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 8,
    ...
    ap_condition_979_assign_proc : process(ap_block_pp0_stage0, ap_reg_pp0_iter2_or_cond_i_i_i_i_reg_1363, ap_enable_reg_pp0_iter3)
    begin
                ap_condition_979 <= ((ap_reg_pp0_iter2_or_cond_i_i_i_i_reg_1363 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter3 = ap_const_logic_1));
    end process;
    ...
    k_buf_0_val_4_d1_assign_proc : process(icmp_reg_1316, tmp_21_i_i_reg_1266, ap_reg_pp0_iter2_reg_444, tmp_76_i_i_reg_1321, k_buf_0_val_3_load_reg_1404, ap_condition_979)
    begin
    ...
    k_buf_0_val_5_d1_assign_proc : process(icmp_reg_1316, tmp_21_i_i_reg_1266, ap_reg_pp0_iter2_reg_444, tmp_76_i_i_reg_1321, k_buf_0_val_4_load_reg_1410, ap_condition_979)
    begin
        if ((ap_const_boolean_1 = ap_condition_979)) then
            if (((tmp_21_i_i_reg_1266 = ap_const_lv1_1) and (icmp_reg_1316 = ap_const_lv1_1))) then 
    ...
    p_059_i_2_0_i_i_fu_968_p3 <= 
        ap_const_lv8_0 when (switch_loc_read_reg_1230(0) = '1') else 
