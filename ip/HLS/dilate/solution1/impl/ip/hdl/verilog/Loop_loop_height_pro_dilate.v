...
module Loop_loop_height_pro_dilate (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_condition_979 = ((ap_reg_pp0_iter2_or_cond_i_i_i_i_reg_1363 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1));
end
...
assign p_059_i_2_0_i_i_fu_968_p3 = ((switch_loc_read_reg_1230[0:0] === 1'b1) ? 8'd0 : src_kernel_win_0_va_5_fu_270);
