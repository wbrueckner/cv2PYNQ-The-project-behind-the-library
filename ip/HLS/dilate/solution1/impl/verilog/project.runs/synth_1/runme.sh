...
HD_PWD='C:/Users/sdi_admin/CloudStation/HLS/dilate/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dilate_hls.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dilate_hls.tcl
