...
HD_PWD='C:/Users/sdi_admin/CloudStation/HLS/dilate/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dilate_hls.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dilate_hls.tcl -notrace
