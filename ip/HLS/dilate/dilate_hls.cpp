...
void dilate_hls(wide_stream* in_stream, wide_stream* out_stream, int rows, int cols, int channels, int mode){
...
#pragma HLS pipeline II=4
	...
	hls::filter_opr<hls::dilate_kernel, hls::BORDER_REPLICATE>::filter(g_img_0,g_img_1,kernel,anchor,rows,cols);
