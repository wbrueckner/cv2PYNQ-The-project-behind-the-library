...
set Library     "hls"
set IPName      "filter2D_f"
set Version     "1.0"
set DisplayName "Filter2d_f"
set Revision    "1806251837"
...
set Interfaces {
    s_axi_CONTROL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x14 rows_V W 0x0 "Data signal of rows_V" {{0 32 rows_V W 0 "Bit 31 to 0 Data signal of rows_V"}}} {0x1c cols_V W 0x0 "Data signal of cols_V" {{0 32 cols_V W 0 "Bit 31 to 0 Data signal of cols_V"}}} {0x24 channels_V W 0x0 "Data signal of channels_V" {{0 32 channels_V W 0 "Bit 31 to 0 Data signal of channels_V"}}} {0x2c mode_V W 0x0 "Data signal of mode_V" {{0 32 mode_V W 0 "Bit 31 to 0 Data signal of mode_V"}}} {0x34 r11_V W 0x0 "Data signal of r11_V" {{0 32 r11_V W 0 "Bit 31 to 0 Data signal of r11_V"}}} {0x3c r12_V W 0x0 "Data signal of r12_V" {{0 32 r12_V W 0 "Bit 31 to 0 Data signal of r12_V"}}} {0x44 r13_V W 0x0 "Data signal of r13_V" {{0 32 r13_V W 0 "Bit 31 to 0 Data signal of r13_V"}}} {0x4c r21_V W 0x0 "Data signal of r21_V" {{0 32 r21_V W 0 "Bit 31 to 0 Data signal of r21_V"}}} {0x54 r22_V W 0x0 "Data signal of r22_V" {{0 32 r22_V W 0 "Bit 31 to 0 Data signal of r22_V"}}} {0x5c r23_V W 0x0 "Data signal of r23_V" {{0 32 r23_V W 0 "Bit 31 to 0 Data signal of r23_V"}}} {0x64 r31_V W 0x0 "Data signal of r31_V" {{0 32 r31_V W 0 "Bit 31 to 0 Data signal of r31_V"}}} {0x6c r32_V W 0x0 "Data signal of r32_V" {{0 32 r32_V W 0 "Bit 31 to 0 Data signal of r32_V"}}} {0x74 r33_V W 0x0 "Data signal of r33_V" {{0 32 r33_V W 0 "Bit 31 to 0 Data signal of r33_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 6 machine 64 combinational 0 latency undef II x}
