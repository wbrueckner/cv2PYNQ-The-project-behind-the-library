...
architecture behav of Loop_3_proc is 
    ...
    signal tmp_17_i_i_fu_206_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal tmp_18_i_i_fu_211_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_18_i_i_reg_371 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_20_i_i_mid1_fu_247_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_20_i_i_mid1_reg_400 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_20_i_i4_fu_252_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_20_i_i4_reg_405 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_4_mid2_v_fu_257_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_4_mid2_v_reg_410 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_28_i_i_fu_303_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_28_i_i_reg_420 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_4_reg_440 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_6_fu_279_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_5_fu_273_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_26_i_i_fu_289_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal c_cast_i_i_mid2_cast_fu_269_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_20_i_i_mid2_fu_308_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component move_hls_mul_mul_dEe IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    move_hls_mul_mul_dEe_U16 : component move_hls_mul_mul_dEe
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 9,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_reg_381 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                r1_i_i_reg_170 <= tmp_4_mid2_v_reg_410;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                ...
                tmp_18_i_i_reg_371 <= tmp_18_i_i_fu_211_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_reg_381 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
                ...
                tmp_4_reg_440 <= g_img_1_data_stream_0_V_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_fu_217_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                tmp_20_i_i4_reg_405 <= tmp_20_i_i4_fu_252_p2;
                tmp_20_i_i_mid1_reg_400 <= tmp_20_i_i_mid1_fu_247_p2;
                tmp_28_i_i_reg_420 <= tmp_28_i_i_fu_303_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_fu_217_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_4_mid2_v_reg_410 <= tmp_4_mid2_v_fu_257_p3;
            end if;
        end if;
    end process;
    ...
    ap_phi_mux_r1_i_i_phi_fu_174_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_flatten_reg_381, r1_i_i_reg_170, tmp_4_mid2_v_reg_410)
    begin
        if (((exitcond_flatten_reg_381 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_phi_mux_r1_i_i_phi_fu_174_p4 <= tmp_4_mid2_v_reg_410;
        else 
    ...
    out_stream_last_V_tm_fu_313_p2 <= (tmp_28_i_i_reg_420 and tmp_20_i_i_mid2_fu_308_p3);
    ...
    out_stream_user_V_tm_fu_297_p2 <= "1" when (tmp_26_i_i_fu_289_p3 = ap_const_lv11_0) else "0";
    p_1_rec_i_i_mid2_fu_233_p3 <= 
        ap_const_lv9_0 when (exitcond1_i_i8_fu_228_p2(0) = '1') else 
        ap_phi_mux_p_1_rec_i_i_phi_fu_185_p4;
    p_Result_s_fu_323_p5 <= (((g_img_1_data_stream_0_V_dout & tmp_4_reg_440) & tmp_3_reg_435) & tmp_2_reg_425);
    ...
    tmp_17_i_i_fu_206_p2 <= std_logic_vector(signed(ap_const_lv11_7FF) + signed(tmp_fu_192_p1));
    tmp_18_i_i_fu_211_p2 <= std_logic_vector(signed(ap_const_lv10_3FF) + signed(extLd_fu_203_p1));
    tmp_1_fu_265_p1 <= tmp_4_mid2_v_fu_257_p3(9 - 1 downto 0);
    tmp_20_i_i4_fu_252_p2 <= "1" when (ap_phi_mux_r1_i_i_phi_fu_174_p4 = tmp_17_i_i_fu_206_p2) else "0";
    tmp_20_i_i_mid1_fu_247_p2 <= "1" when (r3_fu_241_p2 = tmp_17_i_i_fu_206_p2) else "0";
    tmp_20_i_i_mid2_fu_308_p3 <= 
        tmp_20_i_i_mid1_reg_400 when (exitcond1_i_i8_reg_390(0) = '1') else 
        tmp_20_i_i4_reg_405;
    tmp_26_i_i_fu_289_p3 <= (tmp_6_fu_279_p4 & tmp_5_fu_273_p2);
    tmp_28_i_i_fu_303_p2 <= "1" when (c_cast_i_i_mid2_cast_fu_269_p1 = tmp_18_i_i_reg_371) else "0";
    tmp_4_mid2_v_fu_257_p3 <= 
        r3_fu_241_p2 when (exitcond1_i_i8_fu_228_p2(0) = '1') else 
        ap_phi_mux_r1_i_i_phi_fu_174_p4;
    tmp_5_fu_273_p2 <= (tmp_1_fu_265_p1 or p_1_rec_i_i_mid2_fu_233_p3);
    tmp_6_fu_279_p4 <= tmp_4_mid2_v_fu_257_p3(10 downto 9);
