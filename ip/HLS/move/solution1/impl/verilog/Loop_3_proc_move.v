...
wire   [10:0] tmp_17_i_i_fu_206_p2;
wire    ap_CS_fsm_state4;
wire   [9:0] tmp_18_i_i_fu_211_p2;
reg   [9:0] tmp_18_i_i_reg_371;
...
wire   [0:0] tmp_20_i_i_mid1_fu_247_p2;
reg   [0:0] tmp_20_i_i_mid1_reg_400;
wire   [0:0] tmp_20_i_i4_fu_252_p2;
reg   [0:0] tmp_20_i_i4_reg_405;
wire   [10:0] tmp_4_mid2_v_fu_257_p3;
reg   [10:0] tmp_4_mid2_v_reg_410;
wire   [0:0] out_stream_user_V_tm_fu_297_p2;
reg   [0:0] out_stream_user_V_tm_reg_415;
wire   [0:0] tmp_28_i_i_fu_303_p2;
reg   [0:0] tmp_28_i_i_reg_420;
...
wire   [1:0] tmp_6_fu_279_p4;
wire   [8:0] tmp_5_fu_273_p2;
wire   [10:0] tmp_26_i_i_fu_289_p3;
wire   [9:0] c_cast_i_i_mid2_cast_fu_269_p1;
wire   [0:0] tmp_20_i_i_mid2_fu_308_p3;
...
move_hls_mul_mul_dEe #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 9 ),
    .din1_WIDTH( 11 ),
    .dout_WIDTH( 20 ))
move_hls_mul_mul_dEe_U16(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_333_p0),
    .din1(grp_fu_333_p1),
...
assign out_stream_last_V_tm_fu_313_p2 = (tmp_28_i_i_reg_420 & tmp_20_i_i_mid2_fu_308_p3);
...
assign out_stream_user_V_tm_fu_297_p2 = ((tmp_26_i_i_fu_289_p3 == 11'd0) ? 1'b1 : 1'b0);

assign p_1_rec_i_i_mid2_fu_233_p3 = ((exitcond1_i_i8_fu_228_p2[0:0] === 1'b1) ? 9'd0 : ap_phi_mux_p_1_rec_i_i_phi_fu_185_p4);

assign p_Result_s_fu_323_p5 = {{{{g_img_1_data_stream_0_V_dout}, {tmp_4_reg_440}}, {tmp_3_reg_435}}, {tmp_2_reg_425}};

assign r3_fu_241_p2 = (11'd1 + ap_phi_mux_r1_i_i_phi_fu_174_p4);

assign tmp_17_i_i_fu_206_p2 = ($signed(11'd2047) + $signed(tmp_fu_192_p1));

assign tmp_18_i_i_fu_211_p2 = ($signed(10'd1023) + $signed(extLd_fu_203_p1));

assign tmp_1_fu_265_p1 = tmp_4_mid2_v_fu_257_p3[8:0];

assign tmp_20_i_i4_fu_252_p2 = ((ap_phi_mux_r1_i_i_phi_fu_174_p4 == tmp_17_i_i_fu_206_p2) ? 1'b1 : 1'b0);

assign tmp_20_i_i_mid1_fu_247_p2 = ((r3_fu_241_p2 == tmp_17_i_i_fu_206_p2) ? 1'b1 : 1'b0);

assign tmp_20_i_i_mid2_fu_308_p3 = ((exitcond1_i_i8_reg_390[0:0] === 1'b1) ? tmp_20_i_i_mid1_reg_400 : tmp_20_i_i4_reg_405);

assign tmp_26_i_i_fu_289_p3 = {{tmp_6_fu_279_p4}, {tmp_5_fu_273_p2}};

assign tmp_28_i_i_fu_303_p2 = ((c_cast_i_i_mid2_cast_fu_269_p1 == tmp_18_i_i_reg_371) ? 1'b1 : 1'b0);

assign tmp_4_mid2_v_fu_257_p3 = ((exitcond1_i_i8_fu_228_p2[0:0] === 1'b1) ? r3_fu_241_p2 : ap_phi_mux_r1_i_i_phi_fu_174_p4);

assign tmp_5_fu_273_p2 = (tmp_1_fu_265_p1 | p_1_rec_i_i_mid2_fu_233_p3);

assign tmp_6_fu_279_p4 = {{tmp_4_mid2_v_fu_257_p3[10:9]}};
