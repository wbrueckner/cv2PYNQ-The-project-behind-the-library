...
(* CORE_GENERATION_INFO="move_hls,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=6.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.250000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=6,HLS_SYN_FF=811,HLS_SYN_LUT=1513}" *)
...
wire    Block_Mat_exit16542_U0_ap_start;
wire    Block_Mat_exit16542_U0_ap_done;
wire    Block_Mat_exit16542_U0_ap_continue;
wire    Block_Mat_exit16542_U0_ap_idle;
wire    Block_Mat_exit16542_U0_ap_ready;
wire   [8:0] Block_Mat_exit16542_U0_p_lshr_f_cast_out_out_din;
wire    Block_Mat_exit16542_U0_p_lshr_f_cast_out_out_write;
wire   [8:0] Block_Mat_exit16542_U0_col_packets_cast_out_out_din;
wire    Block_Mat_exit16542_U0_col_packets_cast_out_out_write;
wire   [19:0] Block_Mat_exit16542_U0_ap_return;
...
wire    Loop_2_proc18_U0_ap_start;
wire    Loop_2_proc18_U0_ap_done;
wire    Loop_2_proc18_U0_ap_continue;
wire    Loop_2_proc18_U0_ap_idle;
wire    Loop_2_proc18_U0_ap_ready;
wire    Loop_2_proc18_U0_g_img_0_data_stream_0_V_read;
wire   [7:0] Loop_2_proc18_U0_g_img_1_data_stream_0_V_din;
wire    Loop_2_proc18_U0_g_img_1_data_stream_0_V_write;
...
wire    Loop_3_proc_U0_col_packets_cast_loc_read;
wire    Loop_3_proc_U0_p_lshr_f_cast_loc_read;
...
reg    ap_sync_reg_Block_Mat_exit16542_U0_ap_ready;
wire    ap_sync_Block_Mat_exit16542_U0_ap_ready;
reg   [1:0] Block_Mat_exit16542_U0_ap_ready_count;
wire    Block_Mat_exit16542_U0_start_full_n;
wire    Block_Mat_exit16542_U0_start_write;
wire    Loop_1_proc_U0_start_full_n;
wire    Loop_1_proc_U0_start_write;
wire    Loop_2_proc18_U0_start_full_n;
wire    Loop_2_proc18_U0_start_write;
...
#0 ap_sync_reg_Block_Mat_exit16542_U0_ap_ready = 1'b0;
#0 Block_Mat_exit16542_U0_ap_ready_count = 2'd0;
end

move_hls_CONTROL_BUS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_CONTROL_BUS_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_CONTROL_BUS_DATA_WIDTH ))
move_hls_CONTROL_BUS_s_axi_U(
...
Block_Mat_exit16542_s Block_Mat_exit16542_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
Loop_1_proc_move Loop_1_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
Loop_2_proc18 Loop_2_proc18_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
Loop_3_proc_move Loop_3_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_Block_Mat_exit16542_U0_ap_ready <= 1'b0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == Block_Mat_exit16542_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Block_Mat_exit16542_U0_ap_ready_count <= (Block_Mat_exit16542_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == Block_Mat_exit16542_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Block_Mat_exit16542_U0_ap_ready_count <= (Block_Mat_exit16542_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_Mat_exit16542_U0_ap_continue = packets_cast_loc_cha_full_n;

assign Block_Mat_exit16542_U0_ap_start = ((ap_sync_reg_Block_Mat_exit16542_U0_ap_ready ^ 1'b1) & ap_start);

assign Block_Mat_exit16542_U0_start_full_n = 1'b1;

assign Block_Mat_exit16542_U0_start_write = 1'b0;
...
assign Loop_2_proc18_U0_ap_continue = 1'b1;

assign Loop_2_proc18_U0_ap_start = ap_start;

assign Loop_2_proc18_U0_start_full_n = 1'b1;

assign Loop_2_proc18_U0_start_write = 1'b0;
...
assign ap_channel_done_packets_cast_loc_cha = Block_Mat_exit16542_U0_ap_done;

assign ap_done = Loop_3_proc_U0_ap_done;

assign ap_idle = ((packets_cast_loc_cha_empty_n ^ 1'b1) & Loop_3_proc_U0_ap_idle & Loop_2_proc18_U0_ap_idle & Loop_1_proc_U0_ap_idle & Block_Mat_exit16542_U0_ap_idle);
...
assign ap_sync_Block_Mat_exit16542_U0_ap_ready = (ap_sync_reg_Block_Mat_exit16542_U0_ap_ready | Block_Mat_exit16542_U0_ap_ready);
...
assign ap_sync_ready = (ap_sync_Loop_1_proc_U0_ap_ready & ap_sync_Block_Mat_exit16542_U0_ap_ready);
