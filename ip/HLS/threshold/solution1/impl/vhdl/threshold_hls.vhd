...
architecture behav of threshold_hls is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "threshold_hls,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=6.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.226000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=2,HLS_SYN_FF=812,HLS_SYN_LUT=1939}";
    ...
    signal thresh_type : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_start : STD_LOGIC;
    signal ap_ready : STD_LOGIC;
    signal ap_done : STD_LOGIC;
    signal ap_idle : STD_LOGIC;
    signal ap_rst_n_AXI_LITE_clk_inv : STD_LOGIC;
    signal Block_Mat_exit16134_U0_ap_start : STD_LOGIC;
    signal Block_Mat_exit16134_U0_ap_done : STD_LOGIC;
    signal Block_Mat_exit16134_U0_ap_continue : STD_LOGIC;
    signal Block_Mat_exit16134_U0_ap_idle : STD_LOGIC;
    signal Block_Mat_exit16134_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit16134_U0_p_lshr_f_cast_out_out_din : STD_LOGIC_VECTOR (8 downto 0);
    signal Block_Mat_exit16134_U0_p_lshr_f_cast_out_out_write : STD_LOGIC;
    signal Block_Mat_exit16134_U0_col_packets_cast_out_out_din : STD_LOGIC_VECTOR (8 downto 0);
    signal Block_Mat_exit16134_U0_col_packets_cast_out_out_write : STD_LOGIC;
    signal Block_Mat_exit16134_U0_ap_return : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal ap_sync_reg_Block_Mat_exit16134_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Block_Mat_exit16134_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit16134_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal Block_Mat_exit16134_U0_start_full_n : STD_LOGIC;
    signal Block_Mat_exit16134_U0_start_write : STD_LOGIC;
    ...
    component Block_Mat_exit16134_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component threshold_hls_CONTROL_BUS_s_axi IS
    generic (
...
begin
    threshold_hls_CONTROL_BUS_s_axi_U : component threshold_hls_CONTROL_BUS_s_axi
    generic map (
    ...
    Block_Mat_exit16134_U0 : component Block_Mat_exit16134_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    ap_sync_reg_Block_Mat_exit16134_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_Block_Mat_exit16134_U0_ap_ready <= ap_const_logic_0;
            else
    ...
    Block_Mat_exit16134_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = Block_Mat_exit16134_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                Block_Mat_exit16134_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit16134_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = Block_Mat_exit16134_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                Block_Mat_exit16134_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit16134_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_Mat_exit16134_U0_ap_continue <= packets_cast_loc_cha_full_n;
    Block_Mat_exit16134_U0_ap_start <= ((ap_sync_reg_Block_Mat_exit16134_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Block_Mat_exit16134_U0_start_full_n <= ap_const_logic_1;
    Block_Mat_exit16134_U0_start_write <= ap_const_logic_0;
    ...
    Threshold_U0_ap_start <= ap_start;
    Threshold_U0_start_full_n <= ap_const_logic_1;
    Threshold_U0_start_write <= ap_const_logic_0;
    ap_channel_done_packets_cast_loc_cha <= Block_Mat_exit16134_U0_ap_done;
    ap_done <= Loop_2_proc_U0_ap_done;
    ap_idle <= ((packets_cast_loc_cha_empty_n xor ap_const_logic_1) and Threshold_U0_ap_idle and Loop_2_proc_U0_ap_idle and Loop_1_proc_U0_ap_idle and Block_Mat_exit16134_U0_ap_idle);
    ...
    ap_sync_Block_Mat_exit16134_U0_ap_ready <= (ap_sync_reg_Block_Mat_exit16134_U0_ap_ready or Block_Mat_exit16134_U0_ap_ready);
    ...
    ap_sync_ready <= (ap_sync_Loop_1_proc_U0_ap_ready and ap_sync_Block_Mat_exit16134_U0_ap_ready);
    in_stream_TREADY <= Loop_1_proc_U0_in_stream_TREADY;
    out_stream_TDATA <= Loop_2_proc_U0_out_stream_TDATA;
    out_stream_TLAST <= Loop_2_proc_U0_out_stream_TLAST;
    out_stream_TUSER <= Loop_2_proc_U0_out_stream_TUSER;
