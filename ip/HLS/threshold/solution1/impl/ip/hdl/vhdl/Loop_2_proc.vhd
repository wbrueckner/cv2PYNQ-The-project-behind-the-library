...
architecture behav of Loop_2_proc is 
    ...
    signal tmp_14_i_i_fu_206_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal tmp_15_i_i_fu_211_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_15_i_i_reg_371 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal tmp_17_i_i_mid1_fu_247_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_17_i_i_mid1_reg_400 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_17_i_i4_fu_252_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_17_i_i4_reg_405 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_6_mid2_v_fu_257_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_6_mid2_v_reg_410 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tmp_25_i_i_fu_303_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_25_i_i_reg_420 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_6_reg_425 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_9_reg_435 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_state7_pp0_stage2_iter0 : BOOLEAN;
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal tmp_10_reg_440 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_5_fu_265_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_8_fu_279_p4 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_7_fu_273_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_23_i_i_fu_289_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal c_cast_i_i_mid2_cast_fu_269_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal tmp_17_i_i_mid2_fu_308_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component threshold_hls_mulcud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    threshold_hls_mulcud_U17 : component threshold_hls_mulcud
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 9,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_reg_381 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                r1_i_i_reg_170 <= tmp_6_mid2_v_reg_410;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                ...
                tmp_15_i_i_reg_371 <= tmp_15_i_i_fu_211_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_reg_381 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
                ...
                tmp_10_reg_440 <= g_img_1_data_stream_0_V_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_fu_217_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                tmp_17_i_i4_reg_405 <= tmp_17_i_i4_fu_252_p2;
                tmp_17_i_i_mid1_reg_400 <= tmp_17_i_i_mid1_fu_247_p2;
                tmp_25_i_i_reg_420 <= tmp_25_i_i_fu_303_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_fu_217_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_6_mid2_v_reg_410 <= tmp_6_mid2_v_fu_257_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_reg_381 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                tmp_6_reg_425 <= g_img_1_data_stream_0_V_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_reg_381 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
                tmp_9_reg_435 <= g_img_1_data_stream_0_V_dout;
            end if;
        end if;
    end process;
    ...
    ap_phi_mux_r1_i_i_phi_fu_174_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_flatten_reg_381, r1_i_i_reg_170, tmp_6_mid2_v_reg_410)
    begin
        if (((exitcond_flatten_reg_381 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_phi_mux_r1_i_i_phi_fu_174_p4 <= tmp_6_mid2_v_reg_410;
        else 
    ...
    out_stream_last_V_tm_fu_313_p2 <= (tmp_25_i_i_reg_420 and tmp_17_i_i_mid2_fu_308_p3);
    ...
    out_stream_user_V_tm_fu_297_p2 <= "1" when (tmp_23_i_i_fu_289_p3 = ap_const_lv11_0) else "0";
    p_1_rec_i_i_mid2_fu_233_p3 <= 
        ap_const_lv9_0 when (exitcond1_i_i8_fu_228_p2(0) = '1') else 
        ap_phi_mux_p_1_rec_i_i_phi_fu_185_p4;
    p_Result_s_fu_323_p5 <= (((g_img_1_data_stream_0_V_dout & tmp_10_reg_440) & tmp_9_reg_435) & tmp_6_reg_425);
    ...
    tmp_14_i_i_fu_206_p2 <= std_logic_vector(signed(ap_const_lv11_7FF) + signed(tmp_fu_192_p1));
    tmp_15_i_i_fu_211_p2 <= std_logic_vector(signed(ap_const_lv10_3FF) + signed(extLd_fu_203_p1));
    tmp_17_i_i4_fu_252_p2 <= "1" when (ap_phi_mux_r1_i_i_phi_fu_174_p4 = tmp_14_i_i_fu_206_p2) else "0";
    tmp_17_i_i_mid1_fu_247_p2 <= "1" when (r3_fu_241_p2 = tmp_14_i_i_fu_206_p2) else "0";
    tmp_17_i_i_mid2_fu_308_p3 <= 
        tmp_17_i_i_mid1_reg_400 when (exitcond1_i_i8_reg_390(0) = '1') else 
        tmp_17_i_i4_reg_405;
    tmp_23_i_i_fu_289_p3 <= (tmp_8_fu_279_p4 & tmp_7_fu_273_p2);
    tmp_25_i_i_fu_303_p2 <= "1" when (c_cast_i_i_mid2_cast_fu_269_p1 = tmp_15_i_i_reg_371) else "0";
    tmp_5_fu_265_p1 <= tmp_6_mid2_v_fu_257_p3(9 - 1 downto 0);
    tmp_6_mid2_v_fu_257_p3 <= 
        r3_fu_241_p2 when (exitcond1_i_i8_fu_228_p2(0) = '1') else 
        ap_phi_mux_r1_i_i_phi_fu_174_p4;
    tmp_7_fu_273_p2 <= (tmp_5_fu_265_p1 or p_1_rec_i_i_mid2_fu_233_p3);
    tmp_8_fu_279_p4 <= tmp_6_mid2_v_fu_257_p3(10 downto 9);
