...
HD_PWD='C:/Users/sdi_admin/CloudStation/HLS/filter2D_5/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter2D_hls_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter2D_hls_5.tcl
