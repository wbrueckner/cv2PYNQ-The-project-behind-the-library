...
architecture behav of Block_Mat_exit406734 is 
    ...
    component erode_hls_mul_32sbkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component erode_hls_mul_32scud IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    erode_hls_mul_32sbkb_U1 : component erode_hls_mul_32sbkb
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    erode_hls_mul_32scud_U2 : component erode_hls_mul_32scud
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
