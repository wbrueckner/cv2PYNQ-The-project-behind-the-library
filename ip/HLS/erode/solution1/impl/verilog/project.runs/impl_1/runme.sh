...
HD_PWD='C:/Users/sdi_admin/CloudStation/HLS/erode/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log erode_hls.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source erode_hls.tcl -notrace
