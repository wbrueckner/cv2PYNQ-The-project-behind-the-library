...
HD_PWD='C:/Users/sdi_admin/CloudStation/HLS/erode/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log erode_hls.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source erode_hls.tcl
