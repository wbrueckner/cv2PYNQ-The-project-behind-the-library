...
HD_PWD='C:/Users/sdi_admin/CloudStation/HLS/canny/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log canny_edge.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source canny_edge.tcl -notrace
