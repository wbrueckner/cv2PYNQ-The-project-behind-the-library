...
always @ (*) begin
    if ((~((kernel_val_2_V_2_out_full_n == 1'b0) | (ap_start == 1'b0) | (kernel_val_2_V_1_out_full_n == 1'b0) | (kernel_val_2_V_0_out_full_n == 1'b0) | (kernel_val_1_V_2_out_full_n == 1'b0) | (kernel_val_1_V_1_out_full_n == 1'b0) | (kernel_val_1_V_0_out_full_n == 1'b0) | (kernel_val_0_V_2_out_full_n == 1'b0) | (kernel_val_0_V_1_out_full_n == 1'b0) | (kernel_val_0_V_0_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((kernel_val_2_V_2_out_full_n == 1'b0) | (ap_start == 1'b0) | (kernel_val_2_V_1_out_full_n == 1'b0) | (kernel_val_2_V_0_out_full_n == 1'b0) | (kernel_val_1_V_2_out_full_n == 1'b0) | (kernel_val_1_V_1_out_full_n == 1'b0) | (kernel_val_1_V_0_out_full_n == 1'b0) | (kernel_val_0_V_2_out_full_n == 1'b0) | (kernel_val_0_V_1_out_full_n == 1'b0) | (kernel_val_0_V_0_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign kernel_val_0_V_0_out_din = r1_V[7:0];

assign kernel_val_0_V_1_out_din = {{r1_V[15:8]}};

assign kernel_val_0_V_2_out_din = {{r1_V[23:16]}};

assign kernel_val_1_V_0_out_din = r2_V[7:0];

assign kernel_val_1_V_1_out_din = {{r2_V[15:8]}};

assign kernel_val_1_V_2_out_din = {{r2_V[23:16]}};

assign kernel_val_2_V_0_out_din = r3_V[7:0];

assign kernel_val_2_V_1_out_din = {{r3_V[15:8]}};

assign kernel_val_2_V_2_out_din = {{r3_V[23:16]}};
