...
reg   [0:0] exitcond_flatten_reg_363;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_pp0_stage1;
reg   [0:0] ap_reg_pp0_iter1_exitcond_flatten_reg_363;
...
reg   [41:0] indvar_flatten_reg_139;
reg   [10:0] r4_i_i_reg_150;
reg   [29:0] p_1_rec_i_i_reg_161;
reg   [30:0] col_packets_loc_read_reg_319;
reg    ap_block_state1;
wire   [10:0] tmp_fu_173_p1;
wire    ap_CS_fsm_state2;
wire   [10:0] tmp_23_i_i_fu_190_p2;
wire    ap_CS_fsm_state6;
wire   [30:0] tmp_36_i_i_fu_195_p2;
reg   [30:0] tmp_36_i_i_reg_347;
wire   [41:0] grp_fu_184_p2;
reg   [41:0] bound_reg_352;
wire   [0:0] tmp_42_i_i_fu_204_p2;
reg   [0:0] tmp_42_i_i_reg_357;
wire    ap_block_state7_pp0_stage0_iter0;
reg    ap_block_state11_pp0_stage0_iter1;
reg    ap_block_state11_io;
reg    ap_block_pp0_stage0_11001;
wire   [0:0] exitcond_flatten_fu_209_p2;
wire   [41:0] indvar_flatten_next_fu_214_p2;
reg   [41:0] indvar_flatten_next_reg_367;
wire   [0:0] tmp_40_i_i_mid1_fu_226_p2;
reg   [0:0] tmp_40_i_i_mid1_reg_372;
wire   [0:0] tmp_40_i_i3_fu_231_p2;
reg   [0:0] tmp_40_i_i3_reg_377;
wire   [10:0] r4_i_i_mid2_fu_236_p3;
reg   [10:0] r4_i_i_mid2_reg_382;
wire   [29:0] p_1_rec_i_i_mid2_fu_244_p3;
reg   [29:0] p_1_rec_i_i_mid2_reg_388;
reg    ap_block_state8_pp0_stage1_iter0;
wire    ap_block_state12_pp0_stage1_iter1;
reg    ap_block_state12_io;
reg    ap_block_pp0_stage1_11001;
reg   [7:0] tmp_1_reg_393;
wire   [0:0] out_stream_user_V_tm_fu_287_p2;
reg   [0:0] out_stream_user_V_tm_reg_398;
wire   [0:0] out_stream_last_V_tm_fu_298_p2;
reg   [0:0] out_stream_last_V_tm_reg_403;
reg   [7:0] tmp_2_reg_408;
reg    ap_block_state9_pp0_stage2_iter0;
reg    ap_block_pp0_stage2_11001;
reg   [7:0] tmp_3_reg_413;
reg    ap_block_state10_pp0_stage3_iter0;
reg    ap_block_pp0_stage3_11001;
wire   [29:0] c_fu_304_p2;
reg   [29:0] c_reg_418;
wire   [31:0] p_Result_s_fu_309_p5;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state7;
reg    ap_block_pp0_stage3_subdone;
reg    ap_block_pp0_stage1_subdone;
reg   [41:0] ap_phi_mux_indvar_flatten_phi_fu_143_p4;
reg   [10:0] ap_phi_mux_r4_i_i_phi_fu_154_p4;
reg   [29:0] ap_phi_mux_p_1_rec_i_i_phi_fu_165_p4;
reg    ap_block_pp0_stage0_01001;
reg    ap_block_pp0_stage1_01001;
wire   [30:0] grp_fu_184_p0;
wire   [10:0] grp_fu_184_p1;
wire   [30:0] c_cast_i_i_fu_200_p1;
wire   [10:0] r2_fu_220_p2;
wire   [10:0] tmp_7_fu_260_p1;
wire   [18:0] tmp_5_fu_269_p4;
wire   [10:0] tmp_4_fu_264_p2;
wire   [29:0] tmp_51_i_i_fu_279_p3;
wire   [30:0] c_cast_i_i_mid2_cast_fu_256_p1;
wire   [0:0] tmp_40_i_i_mid2_fu_251_p3;
wire   [0:0] tmp_53_i_i_fu_293_p2;
...
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [41:0] grp_fu_184_p00;
wire   [41:0] grp_fu_184_p10;
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        indvar_flatten_reg_139 <= indvar_flatten_next_reg_367;
    end else if ((1'b1 == ap_CS_fsm_state6)) begin
        indvar_flatten_reg_139 <= 42'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten_fu_209_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        r4_i_i_mid2_reg_382 <= r4_i_i_mid2_fu_236_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        tmp_1_reg_393 <= g_img_1_data_stream_0_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        tmp_2_reg_408 <= g_img_1_data_stream_0_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten_fu_209_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage3) & (1'b1 == ap_CS_fsm_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage2) & (1'b1 == ap_CS_fsm_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1)) | ((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((((ap_reg_pp0_iter1_exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((exitcond_flatten_reg_363 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond_flatten_fu_209_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage1;
            end else if (((exitcond_flatten_fu_209_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state11_io) | ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state11_io) | ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0))));
end

assign ap_block_pp0_stage1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage1_01001 = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = (((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b1 == ap_block_state12_io) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b1 == ap_block_state12_io) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage2_11001 = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage2_subdone = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

assign ap_block_pp0_stage3 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage3_11001 = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage3_subdone = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end
...
always @ (*) begin
    ap_block_state10_pp0_stage3_iter0 = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state11_io = ((exitcond_flatten_reg_363 == 1'd0) & (out_stream_last_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state11_pp0_stage0_iter1 = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state12_io = ((ap_reg_pp0_iter1_exitcond_flatten_reg_363 == 1'd0) & (out_stream_last_V_1_ack_in == 1'b0));
end
...
always @ (*) begin
    ap_block_state8_pp0_stage1_iter0 = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state9_pp0_stage2_iter0 = ((exitcond_flatten_reg_363 == 1'd0) & (g_img_1_data_stream_0_V_empty_n == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign c_cast_i_i_fu_200_p1 = ap_phi_mux_p_1_rec_i_i_phi_fu_165_p4;

assign c_cast_i_i_mid2_cast_fu_256_p1 = p_1_rec_i_i_mid2_fu_244_p3;

assign c_fu_304_p2 = (30'd1 + p_1_rec_i_i_mid2_reg_388);

assign exitcond_flatten_fu_209_p2 = ((ap_phi_mux_indvar_flatten_phi_fu_143_p4 == bound_reg_352) ? 1'b1 : 1'b0);

assign grp_fu_184_p0 = grp_fu_184_p00;

assign grp_fu_184_p00 = col_packets_loc_read_reg_319;

assign grp_fu_184_p1 = grp_fu_184_p10;

assign grp_fu_184_p10 = tmp_fu_173_p1;

assign indvar_flatten_next_fu_214_p2 = (ap_phi_mux_indvar_flatten_phi_fu_143_p4 + 42'd1);
...
assign out_stream_last_V_tm_fu_298_p2 = (tmp_53_i_i_fu_293_p2 & tmp_40_i_i_mid2_fu_251_p3);
...
assign out_stream_user_V_tm_fu_287_p2 = ((tmp_51_i_i_fu_279_p3 == 30'd0) ? 1'b1 : 1'b0);

assign p_1_rec_i_i_mid2_fu_244_p3 = ((tmp_42_i_i_reg_357[0:0] === 1'b1) ? p_1_rec_i_i_reg_161 : 30'd0);

assign p_Result_s_fu_309_p5 = {{{{g_img_1_data_stream_0_V_dout}, {tmp_3_reg_413}}, {tmp_2_reg_408}}, {tmp_1_reg_393}};

assign r2_fu_220_p2 = (11'd1 + ap_phi_mux_r4_i_i_phi_fu_154_p4);

assign r4_i_i_mid2_fu_236_p3 = ((tmp_42_i_i_fu_204_p2[0:0] === 1'b1) ? ap_phi_mux_r4_i_i_phi_fu_154_p4 : r2_fu_220_p2);

assign tmp_23_i_i_fu_190_p2 = ($signed(11'd2047) + $signed(tmp_fu_173_p1));

assign tmp_36_i_i_fu_195_p2 = ($signed(31'd2147483647) + $signed(col_packets_loc_read_reg_319));

assign tmp_40_i_i3_fu_231_p2 = ((ap_phi_mux_r4_i_i_phi_fu_154_p4 == tmp_23_i_i_fu_190_p2) ? 1'b1 : 1'b0);

assign tmp_40_i_i_mid1_fu_226_p2 = ((r2_fu_220_p2 == tmp_23_i_i_fu_190_p2) ? 1'b1 : 1'b0);

assign tmp_40_i_i_mid2_fu_251_p3 = ((tmp_42_i_i_reg_357[0:0] === 1'b1) ? tmp_40_i_i3_reg_377 : tmp_40_i_i_mid1_reg_372);

assign tmp_42_i_i_fu_204_p2 = (($signed(c_cast_i_i_fu_200_p1) < $signed(col_packets_loc_read_reg_319)) ? 1'b1 : 1'b0);

assign tmp_4_fu_264_p2 = (tmp_7_fu_260_p1 | r4_i_i_mid2_reg_382);

assign tmp_51_i_i_fu_279_p3 = {{tmp_5_fu_269_p4}, {tmp_4_fu_264_p2}};

assign tmp_53_i_i_fu_293_p2 = ((c_cast_i_i_mid2_cast_fu_256_p1 == tmp_36_i_i_reg_347) ? 1'b1 : 1'b0);

assign tmp_5_fu_269_p4 = {{p_1_rec_i_i_mid2_fu_244_p3[29:11]}};

assign tmp_7_fu_260_p1 = p_1_rec_i_i_mid2_fu_244_p3[10:0];
