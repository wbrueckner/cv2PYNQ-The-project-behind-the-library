...
architecture behav of filter2D_hls is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "filter2D_hls,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=6.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=5.210250,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=3,HLS_SYN_DSP=16,HLS_SYN_FF=2759,HLS_SYN_LUT=3979}";
    ...
    signal r1_V : STD_LOGIC_VECTOR (31 downto 0);
    signal r2_V : STD_LOGIC_VECTOR (31 downto 0);
    signal r3_V : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_start : STD_LOGIC;
    signal ap_ready : STD_LOGIC;
    signal ap_done : STD_LOGIC;
    signal ap_idle : STD_LOGIC;
    signal ap_rst_n_AXI_LITE_clk_inv : STD_LOGIC;
    signal Block_Mat_exit38794_U0_ap_start : STD_LOGIC;
    signal Block_Mat_exit38794_U0_ap_done : STD_LOGIC;
    signal Block_Mat_exit38794_U0_ap_continue : STD_LOGIC;
    signal Block_Mat_exit38794_U0_ap_idle : STD_LOGIC;
    signal Block_Mat_exit38794_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit38794_U0_col_packets_out_out_din : STD_LOGIC_VECTOR (30 downto 0);
    signal Block_Mat_exit38794_U0_col_packets_out_out_write : STD_LOGIC;
    signal Block_Mat_exit38794_U0_col_packets_cast_out_out_din : STD_LOGIC_VECTOR (29 downto 0);
    signal Block_Mat_exit38794_U0_col_packets_cast_out_out_write : STD_LOGIC;
    ...
    signal ap_sync_reg_Block_Mat_exit38794_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Block_Mat_exit38794_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit38794_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    signal Block_Mat_exit38794_U0_start_full_n : STD_LOGIC;
    signal Block_Mat_exit38794_U0_start_write : STD_LOGIC;
    ...
    component Block_Mat_exit38794_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component filter2D_hls_CONTROL_BUS_s_axi IS
    generic (
    ...
    port (
        ...
        r1_V : OUT STD_LOGIC_VECTOR (31 downto 0);
        r2_V : OUT STD_LOGIC_VECTOR (31 downto 0);
        r3_V : OUT STD_LOGIC_VECTOR (31 downto 0);
...
begin
    filter2D_hls_CONTROL_BUS_s_axi_U : component filter2D_hls_CONTROL_BUS_s_axi
    generic map (
    ...
    Block_Mat_exit38794_U0 : component Block_Mat_exit38794_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Block_Mat_exit38794_U0_ap_start,
        ap_done => Block_Mat_exit38794_U0_ap_done,
        ap_continue => Block_Mat_exit38794_U0_ap_continue,
        ap_idle => Block_Mat_exit38794_U0_ap_idle,
        ap_ready => Block_Mat_exit38794_U0_ap_ready,
        rows => rows,
        cols => cols,
        channels => channels,
        col_packets_out_out_din => Block_Mat_exit38794_U0_col_packets_out_out_din,
        col_packets_out_out_full_n => col_packets_loc_c_full_n,
        col_packets_out_out_write => Block_Mat_exit38794_U0_col_packets_out_out_write,
        col_packets_cast_out_out_din => Block_Mat_exit38794_U0_col_packets_cast_out_out_din,
        col_packets_cast_out_out_full_n => ap_const_logic_1,
        col_packets_cast_out_out_write => Block_Mat_exit38794_U0_col_packets_cast_out_out_write,
        ap_return => Block_Mat_exit38794_U0_ap_return);
    ...
    port map (
        ...
        if_din => Block_Mat_exit38794_U0_col_packets_out_out_din,
        if_full_n => col_packets_loc_c_full_n,
        if_write => Block_Mat_exit38794_U0_col_packets_out_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit38794_U0_ap_return,
        if_full_n => packets_loc_channel_full_n,
        if_write => Block_Mat_exit38794_U0_ap_done,
    ...
    ap_sync_reg_Block_Mat_exit38794_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_Block_Mat_exit38794_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_Block_Mat_exit38794_U0_ap_ready <= ap_const_logic_0;
                else 
                    ap_sync_reg_Block_Mat_exit38794_U0_ap_ready <= ap_sync_Block_Mat_exit38794_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    Block_Mat_exit38794_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = Block_Mat_exit38794_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                Block_Mat_exit38794_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit38794_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = Block_Mat_exit38794_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                Block_Mat_exit38794_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit38794_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_Mat_exit38794_U0_ap_continue <= packets_loc_channel_full_n;
    Block_Mat_exit38794_U0_ap_start <= ((ap_sync_reg_Block_Mat_exit38794_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Block_Mat_exit38794_U0_start_full_n <= ap_const_logic_1;
    Block_Mat_exit38794_U0_start_write <= ap_const_logic_0;
    ...
    ap_channel_done_packets_loc_channel <= Block_Mat_exit38794_U0_ap_done;
    ap_done <= Loop_2_proc_U0_ap_done;
    ap_idle <= ((packets_loc_channel_empty_n xor ap_const_logic_1) and Loop_2_proc_U0_ap_idle and Loop_1_proc_U0_ap_idle and Filter2D_U0_ap_idle and Block_proc_U0_ap_idle and Block_Mat_exit38794_U0_ap_idle);
    ...
    ap_sync_Block_Mat_exit38794_U0_ap_ready <= (ap_sync_reg_Block_Mat_exit38794_U0_ap_ready or Block_Mat_exit38794_U0_ap_ready);
    ...
    ap_sync_ready <= (ap_sync_Loop_1_proc_U0_ap_ready and ap_sync_Block_proc_U0_ap_ready and ap_sync_Block_Mat_exit38794_U0_ap_ready);
    in_stream_TREADY <= Loop_1_proc_U0_in_stream_TREADY;
    out_stream_TDATA <= Loop_2_proc_U0_out_stream_TDATA;
    out_stream_TLAST <= Loop_2_proc_U0_out_stream_TLAST;
    out_stream_TUSER <= Loop_2_proc_U0_out_stream_TUSER;
