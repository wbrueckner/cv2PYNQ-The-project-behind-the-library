...
#(parameter
    ...
    output wire [31:0]                   r1_V,
    output wire [31:0]                   r2_V,
    output wire [31:0]                   r3_V,
...
localparam
    ...
    ADDR_CHANNELS_DATA_0 = 7'h24,
    ADDR_CHANNELS_CTRL   = 7'h28,
    ADDR_MODE_DATA_0     = 7'h2c,
    ADDR_MODE_CTRL       = 7'h30,
    ADDR_R1_V_DATA_0     = 7'h34,
    ADDR_R1_V_CTRL       = 7'h38,
    ADDR_R2_V_DATA_0     = 7'h3c,
    ADDR_R2_V_CTRL       = 7'h40,
    ADDR_R3_V_DATA_0     = 7'h44,
    ADDR_R3_V_CTRL       = 7'h48,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_r1_V = 'b0;
    reg  [31:0]                   int_r2_V = 'b0;
    reg  [31:0]                   int_r3_V = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_R1_V_DATA_0: begin
                    rdata <= int_r1_V[31:0];
                end
                ADDR_R2_V_DATA_0: begin
                    rdata <= int_r2_V[31:0];
                end
                ADDR_R3_V_DATA_0: begin
                    rdata <= int_r3_V[31:0];
                end
            endcase
        end
...
assign r1_V             = int_r1_V;
assign r2_V             = int_r2_V;
assign r3_V             = int_r3_V;
// ap_start_mask
...
always @(posedge clk) begin
    if (rst)
        int_r1_V[31:0] <= 0;
    else if (w_hs && waddr == ADDR_R1_V_DATA_0)
        int_r1_V[31:0] <= (WDATA[31:0] & wmask) | (int_r1_V[31:0] & ~wmask);
end
// int_r2_V[31:0]
always @(posedge clk) begin
    if (rst)
        int_r2_V[31:0] <= 0;
    else if (w_hs && waddr == ADDR_R2_V_DATA_0)
        int_r2_V[31:0] <= (WDATA[31:0] & wmask) | (int_r2_V[31:0] & ~wmask);
end
// int_r3_V[31:0]
always @(posedge clk) begin
    if (rst)
        int_r3_V[31:0] <= 0;
    else if (w_hs && waddr == ADDR_R3_V_DATA_0)
        int_r3_V[31:0] <= (WDATA[31:0] & wmask) | (int_r3_V[31:0] & ~wmask);
end
