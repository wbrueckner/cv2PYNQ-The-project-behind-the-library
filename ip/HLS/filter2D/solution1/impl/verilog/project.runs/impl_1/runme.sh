...
HD_PWD='C:/Users/sdi_admin/CloudStation/HLS/filter2D/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log filter2D_hls.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source filter2D_hls.tcl -notrace
